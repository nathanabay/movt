...
let content = fs.readFileSync('src/components/movie-details/StreamList.jsx', 'utf8');
...
fs.writeFileSync('src/components/movie-details/StreamList.jsx', newContent);
console.log('StreamList updated');
